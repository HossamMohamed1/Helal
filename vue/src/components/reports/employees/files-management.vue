      ...
      <v-card class="pa-2">
        <div class="d-flex align-center justify-space-between">
          <v-tabs v-model="tab" :show-arrows="false" background-color="transparent">
            <v-tab to="#tabs-employees">{{ $t("employees.employees") }}</v-tab>
            <v-tab to="#tabs-departments">{{ $t("employees.administrations") }}</v-tab>
          </v-tabs>
          <div >
            <v-dialog
              v-model="dialog"
        ...
        <v-tabs-items v-model="tab" class="py-3">
          <v-tab-item value="tabs-employees">
            <v-row>
              <v-col cols="2" v-for="file in files">
                <v-card class="grey lighten-4 shadow-none">
                  <div class="py-1 px-1 d-flex align-center justify-space-between">
                    <div class="d-flex align-center ">
                      <img src="/images/txt.png" alt="file" width="24">
                      <div class="text-h6 mx-1 font-weight-medium">{{ file.name }}</div>
                    </div>
                    <div>
                      <v-menu offset-y>
                        <template v-slot:activator="{ on, attrs }">
                        ...
                        <v-list>
                          ...
                          <v-list-item>
                            <v-list-item-icon><v-icon >mdi-cloud-download-outline</v-icon></v-list-item-icon>
                            <v-list-item-content>
          ...
          <v-tab-item value="tabs-departments">
            <v-row>
              <v-col cols="2" v-for="file in files">
                <v-card class="grey lighten-4 shadow-none">
                  <div class="py-1 px-1 d-flex align-center justify-space-between">
