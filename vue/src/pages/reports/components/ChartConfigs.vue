  ...
  >
    ...
    <v-card flat style="border-radius: 0">
      <div class=" container">
        ...
        <!--for spline -->
        <div v-else-if="chartOptions.type == 'spline'">
          <div class="row pt-1">
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Color Palette</div>
              <div class="color-palette d-flex mb-2">
            ...
            <div class="col-lg-4 py-0">
              ...
              <v-select
                ...
                label="Curve"
                solo
                v-model="config.plotOptions.spline.marker.symbol"
              ></v-select>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Size</div>
              <v-text-field
                solo
                type="number"
                v-model="config.plotOptions.spline.marker.radius"
              ></v-text-field>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker color</div>
              <input
                type="color"
                v-model="config.plotOptions.spline.marker.fillColor"
              />
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Stroke Width</div>
              <v-text-field
                solo
                type="number"
                v-model="config.plotOptions.spline.marker.lineWidth"
              ></v-text-field>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Stroke color</div>
        ...
        <!--for spline -->
        <div v-else-if="chartOptions.type == 'area'">
          <div class="row pt-1">
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Color Palette</div>
              <div class="color-palette d-flex mb-2">
            ...
            <div class="col-lg-4 py-0">
              ...
              <v-select
                ...
                label="Curve"
                solo
                v-model="config.plotOptions.area.marker.symbol"
              ></v-select>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Size</div>
              <v-text-field
                solo
                type="number"
                v-model="config.plotOptions.area.marker.radius"
              ></v-text-field>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker color</div>
              <input
                type="color"
                v-model="config.plotOptions.area.marker.fillColor"
              />
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Stroke Width</div>
              <v-text-field
                solo
                type="number"
                v-model="config.plotOptions.area.marker.lineWidth"
              ></v-text-field>
            </div>
            <div class="col-lg-4 py-0">
              <div class="font-weight-bold mb-1">Marker Stroke color</div>
