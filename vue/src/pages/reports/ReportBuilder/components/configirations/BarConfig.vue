<template>
  <div class="aside-config" v-if="config">
    ...
    <div class="pa-2">
      ...
      <v-text-field solo v-model="config.cellStartLocation"></v-text-field>
      <legend>cell End Location</legend>
      <v-text-field solo v-model="config.cellEndLocation"></v-text-field>
      ...
      <div v-if="!config.labels.disabled">
        <v-row>
          <v-col cols="6" class="pb-0">
            ...
            <v-text-field solo v-model="config.labels.fontSize"></v-text-field>
            <legend>Width</legend>
            <v-text-field solo v-model="config.labels.width"></v-text-field>
          </v-col>
          <v-col cols="6" class="pb-0">
      ...
      <v-row>
        ...
        <!--            </v-btn-toggle>-->
        <!--          </v-col>-->
        <v-col cols="6" class="pb-0" v-if="!config.legend.disabled">
        ...
        <v-col cols="6" class="pb-0" v-if="!config.legend.disabled">
          <legend>Padding Bottom</legend>
          <v-text-field
            solo
            type="number"
            v-model="config.legend.paddingBottom"
          ></v-text-field
        ></v-col>
        <v-col cols="6" class="pb-0" v-if="!config.legend.disabled">
          ...
          <v-text-field
            solo
            type="number"
            v-model="config.legend.paddingTop"
          ></v-text-field>
        </v-col>
      </v-row>
