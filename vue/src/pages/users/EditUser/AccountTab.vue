  ...
  <div class="my-2">
    <div>
      <v-card v-if="user.disabled" class="warning mb-4" light>
        ...
        <v-card-subtitle>{{ $t('users.ThisuserhasbeendisabledLoginaccessshasbeenrevoked') }}</v-card-subtitle>
        <v-card-text>
      ...
      <v-expansion-panels v-model="panel" multiple class="mt-3">
        ...
        <v-expansion-panel>
          <v-expansion-panel-header class="title">{{ $t('users.Metadata') }}</v-expansion-panel-header>
        ...
        <v-expansion-panel>
          <v-expansion-panel-header class="title">{{ $t('users.RawData') }}</v-expansion-panel-header>
          <v-expansion-panel-content>
