  ...
  <div class="d-flex flex-column flex-grow-1">
    ...
    <v-card>
      ...
      <v-row dense class="pa-2 align-center">
        ...
        <v-col cols="6" class="d-flex text-right align-center">
          ...
          <v-btn :loading="isLoading" icon small class="mx-1">
      ...
      >
        ...
        <template v-slot:item.action="{ item }">
          <div class="actions" @click.stop="dialog = true">
            <v-btn color="primary" @click="open(item)">
    ...
    >
      <v-card>
        ...
        >
          ...
          <span class="cursor-pointer" @click="closeCapturedImage"> X </span>
        </v-card-title>
        <v-card-text>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="image-cover position-relative">
                    <div
                      style="
                        background-image: url('/images/models/pipe-1.jpg');
                        height: 300px;
                    ...
                    >
                      <span
                        class="image-mark"
                        style="top: 20%; left: 30%; border-color: red"
                      ></span>
                      <span
                        class="image-mark"
                        style="top: 40%; left: 45%; border-color: yellow"
                      ></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="data-cont">
                    <div>
                      <h6 class="blue-grey darken-3">Camera ID</h6>
                      23
                    </div>
                  </div>
                </div>
    ...
    >
      <v-card>
        ...
        >
          ...
          <span class="cursor-pointer" @click="closeAllCapturedImage"> X </span>
        </v-card-title>
        <v-card-text>
          <div class="captured_images_body">
            <div class="captured_images_scroll position-relative scroll-y">
              <div class="row ma-0">
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-1.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 1</v-btn
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-2.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 2</v-btn
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-3.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 3</v-btn
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-4.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 4</v-btn
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-5.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 5</v-btn
                      >
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pa-1">
                  <div class="overlay-wrapper">
                    <img
                      :src="require('@/assets/images/images/models/pipe-6.jpg')"
                      alt=""
                    />
                    <div class="overlay-layer bg-dark bg-opacity-10">
                      <v-btn color="primary">
                        {{ $t("general.screenshot") }} 6</v-btn
                      >
                    </div>
                  </div>
                </div>
    ...
    >
      <v-card>
        ...
        >
          {{ $t("general.settings") }}
          <span class="cursor-pointer" @click="CloseImageSettings"> X </span>
        </v-card-title>
        <v-card-text>
          <div class="captured_images_body">
            <div class="captured_images_scroll position-relative scroll-y">
