export default {
  ...
  users: {
    ...
    'Sendsaresetpasswordemailtotheuser': 'إرسال بريدًا إلكترونيًا لإعادة تعيين كلمة المرور إلى المستخدم.',
    'SendResetPasswordEmail': 'إرسال بريد إلكتروني لإعادة تعيين كلمة المرور',
    'ExportAccountData': 'تصدير بيانات الحساب',
    'Exportalltheplatformmetadataforthisuser': 'تصدير جميع البيانات الوصفية للنظام الأساسي لهذا المستخدم.',
    'ExportUserData': 'تصدير بيانات المستخدم',
    'DangerZone': 'منطقة الخطر',
    'Fulladministratorwithaccesstothisdashboard': 'مسؤول كامل لديه حق الوصول إلى لوحة القيادة هذه.',
    'Removeadminaccess': 'إزالة وصول المسؤول',
    'SetUserasAdmin': 'تعيين المستخدم كمسؤول',
    'Preventtheuserfromsigninginontheplatform': 'منع المستخدم من تسجيل الدخول على النظام الأساسي.',
    'EnableUser': 'تفعيل المستتخدم',
    'DisableUser': 'تعطيل الميتخدم',
    'Areyousureyouwanttodisablethisuser': 'هل أنت متأكد أنك تريد تعطيل هذا المستخدم؟',
    ...
    'ThisuserhasbeendisabledLoginaccessshasbeenrevoked': 'تم تعطيل هذا المستخدم! تم إبطال الوصول إلى تسجيل الدخول.',
    'Metadata': 'كلام الوصف',
  ...
  'employees': {
    ...
    'females': 'الإناث',
    'attendees': 'الحضور',
    'employeesInPublicAgenciesAndAdministrations': 'الموظفين في الوكالات والادارات العامة',
    'employeesByGender': 'الموظفين حسب الجنس',
    'employeesByHeadquarters': 'الموظفين حسب المقر',
    'employeesAccordingToTheirQualifications': 'الموظفين حسب مؤهلاتهم وتوزيهم في الادارات',
    'employeesAccordingToTheirQualificationsIn': 'الموظفين حسب مؤهلاتهم وتوزيهم في',
    ...
    'EmployeesAccordingAttendance': 'الموظفين حسب حالات الحضور والغياب والأجازات والمهام ولاإستئذان',
    'absence': 'الغياب',
    'vacations': 'الأجازات',
    'tasks': 'المهام',
  ...
  'permits': {
    ...
    'TheTotalMaterialsUsedInTheRamadanBreakfast': 'المواد المستخدمة في إفطار رمضان',
    'NumberOfEstablishmentsOperatingInTheRamadanIftar': 'المؤسسات العامله في إفطار رمضان',
